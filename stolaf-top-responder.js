...
command: [
	'echo "[";',
	'curl --silent "https://help.stolaf.edu/helpdesk/WebObjects/Helpdesk.woa/ra/Tickets?style=details&qualifier=%28statustype.statusTypeName%3D%27Open%27%29&limit=25&apiKey=dYqqjOjwkOd2k411ytv8G6rADIgpCbWZ59WouoEc" || echo "null";',
	'echo ",";',
	'curl --silent "https://help.stolaf.edu/helpdesk/WebObjects/Helpdesk.woa/ra/Tickets?style=details&qualifier=(statustype.statusTypeName%20%3D%20%27Closed%27)&limit=25&apiKey=dYqqjOjwkOd2k411ytv8G6rADIgpCbWZ59WouoEc" || echo "null";',
	'echo "]";',
].join(''),
